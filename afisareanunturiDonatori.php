                ...
                <form action="" method="POST">
                    <div class="card shadow mt-3">
                        ...
                        <div class="card-body">
							...
							<label for="financiara" class="radio-inline"><input type="radio" name="tip" value="Mobilier" id="financiara"><b> Mobilier</b></label><br>
			...
			<div class="row mt-4">
								...
								<?php 
															...
															<div class="card">
																...
																<div class="card-body">
																	...
																	<p class="card-text">
																		...
																		<a href="favorite.php?delete=<?php echo $row["id"];?>" style="text-decoration: none;"><i style="color:red;" class="fa fa-trash-o" aria-hidden="true"></i><b> Remove</b></a>
																	</p>
																</div>
															</div>
														</div>
												...
												if(isset($_POST['submit']) && isset($_POST['judeteRom'])){
													$str = $_POST['judeteRom'];
												 	$query2 = "SELECT * FROM anunturidonatori WHERE judet='$str' ";
															...
															<div class="card">
																...
																<div class="card-body">
																	...
																	<p class="card-text">
																		...
																		<a href="favorite.php?favorit=<?php echo $row["id"];?>" style="text-decoration: none;"><i style="color:#F6F640;" class="fa fa-star" aria-hidden="true"></i>Add to favorite</a>
																	</p>
																</div>
															</div>
														</div>
